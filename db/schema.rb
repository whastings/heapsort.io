...
ActiveRecord::Schema.define(version: 20140328200235) do
  ...
  add_index "user_interactions", ["interactive_id", "interactive_type"], name: "index_user_interactions_on_interactive_id_and_interactive_type", using: :btree
